...
class dtype:
    ...
    def __init__(self, obj: _DtypeLike, align: bool = ..., copy: bool = ...,
                 ) -> None:
        ...
...
class ndarray(_ArrayOrScalarCommon, Iterable, Sized, Container):
    ...
    def view(self,
             dtype: _DtypeLike,
             type: Type[_NdArraySubClass]) -> _NdArraySubClass:
        ...
    ...
    def getfield(
            self, dtype: Union[_DtypeLike, str], offset: int = ...) -> ndarray:
        ...
    ...
    @overload
    def resize(
            self, new_shape: Sequence[int], *, refcheck: bool = ...) -> None:
        ...
