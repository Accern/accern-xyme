...
export declare type TaskType = 'node:cpubig' | 'node:cpusmall';
export declare type QueueType = 'parallel:kafka' | 'parallel:queue';
export declare type QueueStatus = 'waiting' | 'running' | 'result' | 'error' | 'void';
export declare type TaskStatus = 'blocked' | 'waiting' | 'running' | 'complete' | 'eos' | 'paused' | 'error' | 'unknown' | 'virtual' | 'queue';
export declare type ParamType = 'bool' | 'choice_list' | 'choice_set' | 'choice' | 'col' | 'date' | 'int' | 'list_col' | 'list_str' | 'list_tup_str' | 'mapping_col_num' | 'mapping_col_type' | 'mapping_int_int' | 'mapping_str_str' | 'mapping_str_tup_str_int' | 'mapping_tup_int_float' | 'mapping_tup_int_tup_int_int_int_int' | 'mapping_tup_str_str' | 'num' | 'opt_col' | 'opt_coltype' | 'opt_date' | 'opt_int' | 'opt_scol' | 'opt_str' | 'pair_num' | 'scol' | 'str' | 'col_or_mapping_str_col';
export declare type InstanceStatus = 'busy_queue' | 'busy_task' | 'data_queue' | 'off' | 'ready_queue' | 'ready_task';
...
export declare type BlobType = 'bucket_buff' | 'context' | 'csr_matrix' | 'csv' | 'custom_code' | 'dag' | 'data' | 'data_adaptive' | 'datalike' | 'dataresult' | 'embedding_model' | 'es' | 'json' | 'raw' | 'seq_buff' | 'sklearn_model' | 'sorting_buff' | 'text_embedding_model' | 'text_model_clf' | 'text_model_reg' | 'tmp' | 'torch';
...
export declare type DictStrStr = {
    [key: string]: string;
};
export declare type DynamicFormat = 'simple' | 'titan';
