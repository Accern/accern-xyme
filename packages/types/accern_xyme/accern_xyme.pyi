...
class BlobHandle:
    ...
    def upload_sklike_model_file(self, model_obj: IO[bytes], xcols: List[str], is_clf: bool, model_name: str, version: int = ..., maybe_classes: Optional[List[str]] = ..., maybe_range: Optional[Tuple[Optional[float], Optional[float]]] = ..., delete_later_versions: bool = ..., full_init: bool = ...) -> UploadFilesResponse: ...
    def upload_sklike_model(self, model: Any, xcols: List[str], is_clf: bool, version: int = ..., maybe_classes: Optional[List[str]] = ..., maybe_range: Optional[Tuple[Optional[float], Optional[float]]] = ..., delete_later_versions: bool = ..., full_init: bool = ...) -> UploadFilesResponse: ...
    ...
    def set_model_version_tag(self, version: int, name: str) -> ModelVersionTagsResponse: ...
