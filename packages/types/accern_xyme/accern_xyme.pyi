...
class BlobHandle:
    ...
    def upload_sklike_model(self, model: Any, xcols: Optional[List[str]], ycols: Optional[List[str]], is_clf: bool, model_name: str = ..., version: int = ..., model_params: Dict[str, Any] = ..., delete_later_versions: bool = ..., full_init: bool = ...) -> UploadFilesResponse: ...
