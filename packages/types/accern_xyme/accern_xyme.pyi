...
class BlobHandle:
    ...
    def upload_sklike_model(self, source: Union[str, io.BytesIO], xcols: List[str], is_clf: bool, model_name: str, maybe_classes: Optional[List[str]], maybe_range: Optional[Tuple[Optional[float], Optional[float]]], full_init: bool=...) -> UploadFilesResponse: ...
