...
class BlobHandle:
    ...
    def upload_model_file(self, model_obj: IO[bytes], xcols: Optional[List[str]], ycols: Optional[List[str]], is_clf: bool, model_name: str, version: int = ..., model_params: Dict[str, Any] = ..., delete_later_versions: bool = ..., max_threads: int = ..., full_init: bool = ...) -> UploadFilesResponse: ...
    def upload_sklike_model(self, model: Any, xcols: List[str], ycols: Optional[List[str]], is_clf: bool, model_name: str = ..., version: int = ..., model_params: Dict[str, Any] = ..., delete_later_versions: bool = ..., full_init: bool = ...) -> UploadFilesResponse: ...
