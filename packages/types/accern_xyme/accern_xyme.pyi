...
class XYMEClient:
    ...
    def set_dag(self, dag_uri: str, defs: UserDagDef, warnings_io: Optional[IO[Any]] = ...) -> DagHandle: ...
...
class DagHandle:
    ...
    def get_def(self, full: bool = ...) -> UserDagDef: ...
    ...
    def download_full_dag_zip(self, to_path: Optional[str], include_synthetic: bool = ...) -> Optional[io.BytesIO]: ...
...
class BlobHandle:
    ...
    def list_files(self, include_synthetic: bool = ...) -> List['BlobHandle']: ...
    def as_str(self) -> str: ...
    ...
    def download_zip(self, to_path: Optional[str], include_synthetic: bool = ...) -> Optional[io.BytesIO]: ...
    def upload_zip(self, source: Union[str, io.BytesIO], max_threads: int = ...) -> List['BlobHandle']: ...
    def upload_model_file(self, model_obj: IO[bytes], xcols: Optional[List[str]], ycols: Optional[List[str]], is_clf: bool, model_name: str, version: int = ..., model_params: Optional[Dict[str, Any]] = ..., delete_later_versions: bool = ..., max_threads: int = ..., full_init: bool = ...) -> UploadFilesResponse: ...
    def upload_sklike_model(self, model: Any, xcols: List[str], ycols: Optional[List[str]], is_clf: bool, model_name: Optional[str] = ..., version: int = ..., model_params: Optional[Dict[str, Any]] = ..., delete_later_versions: bool = ..., full_init: bool = ...) -> UploadFilesResponse: ...
