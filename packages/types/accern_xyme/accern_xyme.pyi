...
class BlobHandle:
    ...
    def upload_sklike_model_file(self, model_obj: IO[bytes], xcols: List[str], ycols: Optional[List[str]], is_clf: bool, model_name: str, maybe_classes: Optional[List[str]] = ..., maybe_range: Optional[Tuple[Optional[float], Optional[float]]] = ..., full_init: bool = ...) -> UploadFilesResponse: ...
    def upload_sklike_model(self, model: Any, xcols: List[str], ycols: Optional[List[str]], is_clf: bool, maybe_classes: Optional[List[str]] = ..., maybe_range: Optional[Tuple[Optional[float], Optional[float]]] = ..., full_init: bool = ...) -> UploadFilesResponse: ...
